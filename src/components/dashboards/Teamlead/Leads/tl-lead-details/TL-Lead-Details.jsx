...
import TLUpdateLead from '../tl-lead-components/lead-update';
import TlGeneratePaymentLinkModal from '../tl-lead-components/lead-payment';
import TlLeadActivity from './tl-lead-detailcompo/lead-activity';
import TlLeadPayments from './tl-lead-detailcompo/lead-payment';
import TlLeadNotes from './tl-lead-detailcompo/lead-notes';
import TlFollowUpScheduler from './tl-lead-detailcompo/followSchedule';
import { useNavigate, useLocation, useParams } from "react-router-dom";

export default function TeamleadLeadDetail({ leadId, onNavigate, userRole }) {
