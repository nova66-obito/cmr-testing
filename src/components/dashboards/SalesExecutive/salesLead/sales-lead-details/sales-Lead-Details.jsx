...
import SalesLeadForm from '../sales-lead-compo/add-Lead-form';
import SalesUpdateLead from '../sales-lead-compo/lead-update';
import SalesGeneratePaymentLinkModal from '../sales-lead-compo/lead-payment';
import SalesFollowUpScheduler from './sales-details-compo/followSchedule';
import SalesLeadPayments from './sales-details-compo/lead-payment';
import SalesLeadNotes from './sales-details-compo/lead-notes';
import SalesLeadActivity from './sales-details-compo/lead-activity';
import { useNavigate, useLocation, useParams } from "react-router-dom";


export default function MeanagerLeadDetail({ leadId, onNavigate, userRole }) {
